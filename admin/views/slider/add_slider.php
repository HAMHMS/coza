<form method="post" action="functions/slider/insert_slider.php" enctype="multipart/form-data">
    ...
    <div class="form-group col-md-8">
        ...
        <input type="text" class="form-control" placeholder="Enter slider name" name="name">
    </div>
    <div class="form-group col-md-8">
