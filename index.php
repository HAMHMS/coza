...
<!-- Slider -->
	<section class="section-slide">
		...
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1" style="background-image: url(admin/images/<?= $slider['image'] ?>);">
...
$queryCa = $conn -> query($selCat);
foreach($queryCa as $ca){
?>				
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					<!-- Block1 -->

					<div class="block1 wrap-pic-w">
						<img style="width: 200px; height:200px;" src="admin/images/<?= $ca['image'] ?>" alt="IMG-BANNER">

						<a href="product.php" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
							<div class="block1-txt-child1 flex-col-l">
								<span style="color: white;" class="block1-name ltext-102 trans-04 p-b-8">
									<?= $ca['name'] ?>
								</span>
...
?>
                    <a href="?catid=<?= $cat['id'] ?>" class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 how-active1" data-filter="*">
						<?= $cat['name'] ?>
					</a>
<?php } ?>			
				</div>
...
$cat_id = $_GET['catid'];
$selectPro = "SELECT * FROM products WHERE cat_id = $cat_id ";
}
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img style="width: 250px; height:250px;" src="admin/images/<?= $pro['image'] ?>" alt="IMG-PRODUCT">
